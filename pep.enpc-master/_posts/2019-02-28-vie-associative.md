...
<br>
![Grand Paris Express]({{ site.baseurl }}/img/opt/img/posts/tmp-1000.jpg){:class="img-responsive img-centered"}
...
<div style="margin-top: 30px; margin-bottom: 30px;">
    ...
    <div style="text-align: center; margin-right: 20px;margin-left: 20px;">
        <p>
            <i>
                Grâce à mon parcours en GCC (Génie Civil et Construction) et mon expérience de conseil auprès d’Alter’Actions, je savais que j’avais les compétences pour réaliser ce projet et que ça allait aussi beaucoup m’apporter.
            </i>
